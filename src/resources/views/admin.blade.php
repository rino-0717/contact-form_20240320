...
@section('content')
<div class="admin">
    <h2 class="admin_heading content__heading">Admin</h2>
        <div class="admin-form_inner">
            <form class="searc-form" action="/search" method="get">
                @csrf

                <!-- キーワード入力 -->
                <input class="search-form_keyword-input" type="text" name="keyword" placeholder="名前やメールアドレスを入力してください" value="{{request('keyword')}}">

                <!-- 性別選択 -->
                <div class="search-form_gender">
                ...
                <div class="search-form__category">
                    <select class="search-form__category-select" name="category_id">
                        <!-- disabled属性 は、HTML要素を無効化。無効化された要素は、ユーザーが操作することはできない。 -->
